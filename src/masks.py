...
def get_mask_card_number(card_num: str) -> str:
    ...
    hidden_card_num = f"{formated_card_num[0:7]}** **** {formated_card_num[-4:]}"
...
def get_mask_account(acc_num: str) -> str:
    ...
    hiden_acc_num = f"**{shown_acc_num}"
    return hiden_acc_num


print(get_mask_card_number(str(input("Введите номер карты (12 цифр): "))))
print(get_mask_account(str(input("Введите номер счета (16 цифр): "))))
