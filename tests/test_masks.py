...
@pytest.mark.parametrize("card_num, excpected", [("1596837868705199", "1596 83** **** 5199"), ("7158300734726758", "7158 30** **** 6758"), ("6831982476737658", "6831 98** **** 7658"), (" ", "Ошибка: введено не число или неверное количество знаков."), ("123456789", "Ошибка: введено не число или неверное количество знаков."), ("text", "Ошибка: введено не число или неверное количество знаков."), ("", "Ошибка: введено не число или неверное количество знаков."), ("visa567891123456", "Ошибка: введено не число или неверное количество знаков.")])
